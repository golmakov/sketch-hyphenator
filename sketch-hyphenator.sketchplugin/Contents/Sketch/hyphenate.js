...
exports.addHyphens = addHyphens;
exports.removeHyphens = removeHyphens;

var _hypher = __webpack_require__(1);

var _hypher2 = _interopRequireDefault(_hypher);

var _hyphenation = __webpack_require__(2);

var _hyphenation2 = _interopRequireDefault(_hyphenation);

var _hyphenation3 = __webpack_require__(3);

var _hyphenation4 = _interopRequireDefault(_hyphenation3);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var engines = new Array();
engines.push(new _hypher2['default'](_hyphenation2['default']));
engines.push(new _hypher2['default'](_hyphenation4['default']));
...
function addHyphens(context) {
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;

    try {
        for (var _iterator = getTextLayers(context)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var _layer = _step.value;

            var text = _layer.stringValue();
            for (var i = 0; i < engines.length; i++) {
                text = engines[i].hyphenateText(text);
            }
            _layer.setStringValue(text);
        }
    } catch (err) {
...
function removeHyphens(context) {
    var _iteratorNormalCompletion2 = true;
    var _didIteratorError2 = false;
    var _iteratorError2 = undefined;

    try {
        for (var _iterator2 = getTextLayers(context)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var _layer2 = _step2.value;

            var text = _layer2.stringValue();
            text = text.replace(/[\u00AD]/g, "");
            _layer2.setStringValue(text);
        }
    } catch (err) {
...
that['addHyphens'] = __skpm_run.bind(this, 'addHyphens');
that['onRun'] = __skpm_run.bind(this, 'default');
that['removeHyphens'] = __skpm_run.bind(this, 'removeHyphens')
